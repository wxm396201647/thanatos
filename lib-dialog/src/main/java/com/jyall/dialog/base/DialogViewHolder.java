...
public class DialogViewHolder {
    ...
    public void setText(int viewId, CharSequence text) {
        ...
        Log.i(TAG, "setText tv : " + tv + ",text:" + text);
        if (tv != null) {
            if (!TextUtils.isEmpty(text)) {
                tv.setVisibility(View.VISIBLE);
            }
            tv.setText(text);
            Log.i(TAG, "setText tv.getText --> " + tv.getText().toString());
        }
    }
    ...
    public void setImage(int viewId, Bitmap bitmap) {
        ...
        Log.i(TAG, "setImage view : " + view + ",bitmap:" + bitmap);
    ...
    public void setDrawable(int viewId, Drawable drawable) {
        View view = getView(viewId);
        Log.i(TAG, "setDrawable view : " + view + ",resId:" + drawable);
        if (view == null) {
            return;
        }
        //如果drawable不为null，应该让view显示出来
    ...
    public void setOnClickListener(int viewId, final DialogListener listener) {
        View view = getView(viewId);
        Log.i(TAG, "setOnItemClickListener view : " + view + ",listener:" + listener);
        if (view != null) {
