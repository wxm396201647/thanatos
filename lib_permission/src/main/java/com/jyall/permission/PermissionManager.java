 ...
 * Google定义的Runtime权限使用 with() 方法处理即可,
...
public class PermissionManager {
    ...
    public static final String NAME_CAMERA = Manifest.permission.CAMERA;
    public static final String NAME_CONTACT_READ = Manifest.permission.READ_CONTACTS;
    public static final String NAME_LOCATION_FINE = Manifest.permission.ACCESS_FINE_LOCATION;
    public static final String NAME_LOCATION_COARSE = Manifest.permission.ACCESS_COARSE_LOCATION;
    public static final String NAME_RECORD_AUDIO = Manifest.permission.RECORD_AUDIO;
    public static final String NAME_READ_PHONE_STATE = Manifest.permission.READ_PHONE_STATE;
    public static final String NAME_CALL_PHONE = Manifest.permission.CALL_PHONE;
    public static final String NAME_SEND_SMS = Manifest.permission.SEND_SMS;
    public static final String NAME_READ_SMS = Manifest.permission.READ_SMS;
    public static final String NAME_RECEIVE_SMS = Manifest.permission.RECEIVE_SMS;
    public static final String NAME_STORAGE_READ = Manifest.permission.READ_EXTERNAL_STORAGE;
    public static final String NAME_STORAGE_WRITE = Manifest.permission.WRITE_EXTERNAL_STORAGE;
     ...
     */
    public static PermissionOperator with(String... permissions) {
...
//                ApplicationUtils.jumpToApplicationDetail(context);
//            }
//        })
